...
export default function BarChartM(analytics: any) {
	const resDates = analytics.analytics.map((res: any) => {
		return new Date(res.check_in);
	});

	const resNights = analytics.analytics.map((res: any) => {
		return res.nights;
	});
			...
			<CardContent className="px-2 sm:p-6">
				<ChartContainer config={chartConfig}>
					<BarChart accessibilityLayer data={chartData2}>
						...
						<Bar dataKey="desktop" fill="var(--color-views)" radius={4} />
					</BarChart>
				</ChartContainer>
			</CardContent>
		</Card>
